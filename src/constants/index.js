...
export const toys = [
  {
    ...
    color: [],
    description:
      "Number and Counting Learning Board টি শিশুদের প্রাথমিক গণিত শেখার জন্য একটি কার্যকর educational toy।\n\nএই learning board এর মাধ্যমে বাচ্চারা ১ থেকে ২০ পর্যন্ত সংখ্যা চিনতে শেখে এবং counting এর basic concept বুঝতে পারে। Board-এ থাকা visual elements শিশুদের শেখাকে সহজ ও আকর্ষণীয় করে তোলে। যখন বাচ্চারা সংখ্যা মিলানো বা গোনা শেখে, তখন তাদের logical thinking এবং number sense ধীরে ধীরে develop হয়।\n\nএই toy টি শিশুদের cognitive development এ গুরুত্বপূর্ণ ভূমিকা রাখে। Counting activity করার সময় বাচ্চারা focus ধরে রাখতে শেখে এবং memory power উন্নত হয়। Hands-on interaction এর ফলে শেখা আরও দীর্ঘস্থায়ী হয় এবং math ভীতি কমে যায়।\n\nParents চাইলে এই board ব্যবহার করে addition ও subtraction এর প্রাথমিক ধারণাও দিতে পারেন। Play-based learning এর মাধ্যমে শেখার ফলে বাচ্চারা পড়াশোনাকে ভয় না পেয়ে আনন্দের সাথে গ্রহণ করে।\n\nএই board টি strong ও non-toxic material দিয়ে তৈরি, তাই শিশুদের জন্য সম্পূর্ণ safe। Home learning, pre-school বা kindergarten—সব জায়গায় এটি একটি useful math learning tool হিসেবে কাজ করে।",
    qna: [
      {
      ...
      {
        question: "এই খেলনাটি কি গণিত শেখার জন্য কার্যকর?",
        answer:
          "হ্যাঁ, এটি সংখ্যা ও গণনার প্রাথমিক ধারণা তৈরি করতে সাহায্য করে।",
      },
    ],
    reviews: 19,
    sold: 31,
    ...
    qna: [
      {
        ...
        answer:
          "না, এটি সহজ লেভেল থেকে শুরু করে ধীরে ধীরে চ্যালেঞ্জ বাড়ানো যায়।",
      },
      {
    ...
    qna: [
      {
        ...
        answer:
          "হ্যাঁ, এটি বিভিন্ন pre-school ও primary kids size এ available।",
      },
      {
...

  {
    ...
    qna: [
      ...
      {
        question:
          "এই সেট কি role-play এবং learning activity উভয়ের জন্য ব্যবহারযোগ্য?",
        answer:
          "হ্যাঁ, imaginative play এবং educational activity উভয়ের জন্য উপযুক্ত।",
      },
    ],
    reviews: 20,
    sold: 30,
